    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('super_admin', 'Super Admin'), ('it_personnel', 'IT Personnel'), ('end_user', 'End User')], default='end_user', max_length=20)),
            ...
            managers=[
                ('objects', ticketing.models.CustomUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='AuditLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(limit_choices_to={'user_type': 'end_user'}, on_delete=django.db.models.deletion.CASCADE, related_name='created_tickets', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('ticket', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='ticketing.ticket')),
            ],
        ),
    ]
